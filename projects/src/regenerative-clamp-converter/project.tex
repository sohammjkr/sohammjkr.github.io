...
\status{MS Thesis}
\order{1}
\tags{power electronics, thesis, hardware, magnetics, solar}

\link{Read the thesis (PDF)}{/thesis/Design_and_Analysis_of_a_Regenerative_Clamp_Converter_for_Energy_Capture_and_Recovery_in_High_Power_Converter_Topologies.pdf}
...
\pdf{/thesis/Design_and_Analysis_of_a_Regenerative_Clamp_Converter_for_Energy_Capture_and_Recovery_in_High_Power_Converter_Topologies.pdf}{Design and Analysis of a Regenerative Clamp Converter for Energy Capture and Recovery in High Power Converter Topologies}
